...
with open(os.path.join(RESULT_DIR, "model5_lstm.json"), "w") as f:
    json.dump(model_results, f, indent=2)

np.save(os.path.join(RESULT_DIR, "model5_preds.npy"), all_preds)
np.save(os.path.join(RESULT_DIR, "model5_targs.npy"), all_targs)

print(f"\n✓ Results saved to results/model5_lstm.json")
