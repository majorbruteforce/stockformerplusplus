#!/usr/bin/env python
"""Run Transformer only - full folds."""
...
model_results = {"model": "Transformer", "metrics": final_metrics, "n_folds": fold_num}
with open(os.path.join(RESULT_DIR, "model1_transformer.json"), "w") as f:
    json.dump(model_results, f, indent=2)

np.save(os.path.join(RESULT_DIR, "model1_preds.npy"), all_preds)
np.save(os.path.join(RESULT_DIR, "model1_targs.npy"), all_targs)

print(f"\n✓ Results saved to results/model1_transformer.json")
