...
with open(os.path.join(RESULT_DIR, "model4_rnn.json"), "w") as f:
    json.dump(model_results, f, indent=2)

np.save(os.path.join(RESULT_DIR, "model4_preds.npy"), all_preds)
np.save(os.path.join(RESULT_DIR, "model4_targs.npy"), all_targs)

print(f"\n✓ Results saved to results/model4_rnn.json")
